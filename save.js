...
const save = {
    ...
    profile: {
      ...
      properties: {
        ...
        employmentType: {
          ...
          enum: [ null, 'salaried', 'self-employed', 'self-employed/proprietorship', 'student', 'homemaker', 'professional', 'retired', 'pensioner' ],
        },
        fatherName: {
          type: [ 'string', 'null' ],
        },
  ...
  required: [ 'userId', 'partnerCode', 'productCode' ],
  errorMessage: {
    required: {
      userId: 'Parameter: userId is required in the body.',
      partnerCode: 'Parameter: partnerCode is required in the body.',
      productCode: 'Parameter: productCode is required in the body.',
    },
    properties: {
      userId: 'Parameter: userId should be valid uuid.',
      productCode: 'Parameter: productCode should be valid string',
